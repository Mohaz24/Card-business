        ...
        <img 
           ...
           <div id="main">
            <div className="card--content">
                <h1 className="card--content-title">Mohz</h1>
                <p className="card--content-text">Frontend Developer</p>
                <a className="card--content-link">Mohz.website</a>
            </div>
            <div className="card--content">
                <button className="card--content-btn_email">
                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none" className="card--content-svg_one">
                ...
                <button className="card--content-btn_linkedln"> 
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" className="card--content-svg_two">
